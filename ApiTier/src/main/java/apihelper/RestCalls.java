...
public class RestCalls {
	...
	//	public static RequestSpecBuilderCustomized requestSpecBuilderCustomized;
		...
		public static RequestSpecification getGenericRequestSpec(APIMethodType requestType,String body,Map<String, String> headersToBeModified , String BasicToken) throws IOException{
	...
	//		requestSpecBuilderCustomized = new RequestSpecBuilderCustomized();
		...
		public HashMap getResponsedata(APIResponse responseData, String Uniqueid) {
		...
		public HashMap getResponsedata(APIResponse responseData) {
			HashMap ResponseData = new HashMap<String, String>();
